...
function themeSetter(themeCode) {
    switch (themeCode) {
        ...
        case 1:
            ...
            cssElement.style.setProperty('--orange', '#2ab300');
        ...
        case 2:
            cssElement.style.setProperty('--light-grey', '#f6490c');
            cssElement.style.setProperty('--blue', 'red');
            cssElement.style.setProperty('--orange', '#d4af72');
            cssElement.style.setProperty('--red', '#eb8100');
            cssElement.style.setProperty('--headingColor', '#793100');
            cssElement.style.setProperty('--screenBackground', '#f6ebca');
            cssElement.style.setProperty('--displayBufferColor', '#f6490c');
            cssElement.style.setProperty('--buttonBackground', '#f6d785');
            break;
    }
}

var themeCode = 0;
// var select = document.getElementById('dropSelect');
// select.addEventListener('change', function() {
//     themeValue = this.value;
//     console.log(this)
//     console.log(themeValue)
//     themeSetter(themeValue);
// });
